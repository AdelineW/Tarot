...
if ( ! $hide_pdfbutton ) { ?>
	...
	<div class="w-btn-wrapper">
		<a class="w-btn us-btn-style_1 icon_atleft" href="<?php echo esc_url( add_query_arg( 'pdf', $post->ID ) );?>" target="_blank"><span class="dkpdf-button-icon"><i class="fa fa-file-pdf-o"></i></span> <?php echo wp_kses_post($pdfbutton_text);?></a>
	</div>
<?php }
?>
