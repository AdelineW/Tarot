<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots3') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex3') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names3')!== false) ? get_option( 'tarokki_tarot_names3') : array() ;
			...
			update_option( 'tarokki_tarot_names3',$tarotsN2);
			update_option( 'tarokki_tarotsAll3',$tarotsAll);
			update_option( 'tarokki_EDD_products3',$restrict_post_id);
