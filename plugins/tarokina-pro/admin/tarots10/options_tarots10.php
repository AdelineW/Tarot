<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots10') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex10') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names10')!== false) ? get_option( 'tarokki_tarot_names10') : array() ;
			...
			update_option( 'tarokki_tarot_names10',$tarotsN2);
			update_option( 'tarokki_tarotsAll10',$tarotsAll);
			update_option( 'tarokki_EDD_products10',$restrict_post_id);
