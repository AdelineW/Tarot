<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots4') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex4') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names4')!== false) ? get_option( 'tarokki_tarot_names4') : array() ;
			...
			update_option( 'tarokki_tarot_names4',$tarotsN2);
			update_option( 'tarokki_tarotsAll4',$tarotsAll);
			update_option( 'tarokki_EDD_products4',$restrict_post_id);
