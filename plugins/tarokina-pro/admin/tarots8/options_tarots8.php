<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots8') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex8') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names8')!== false) ? get_option( 'tarokki_tarot_names8') : array() ;
			...
			update_option( 'tarokki_tarot_names8',$tarotsN2);
			update_option( 'tarokki_tarotsAll8',$tarotsAll);
			update_option( 'tarokki_EDD_products8',$restrict_post_id);
