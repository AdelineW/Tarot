...
update_option( 'tarokki_carpeta_tarots', $carpeta_tarots );	
    ...
    Container::make( 'theme_options', 'tarots8', esc_html__('Tarots','tarokina-pro') )
    ...
    Field::make( 'html', 'tarokki_cabecera_text_tarots' )
        ...
        </ul><div class=\"titleFormsBloq\"><div class=\"titleForms\">'.esc_html__( 'Tarots','tarokina-pro' ).'&nbsp;71-80</div><span class=\"dashicons dashicons-arrow-down-alt2\"></span></div>
        ')->set_classes( 'infoTarots' ),
    Field::make( 'complex', 'tarokki_tarot_complex8', '' )
    ->set_collapsed( true )
    ->set_max('10')
...
////////////////////////////////////////////////////////////////////////////////
    ...
    $escribir = fopen(TAROKINA_ADMIN_PATH."tarots8/vista8.php", "w");
