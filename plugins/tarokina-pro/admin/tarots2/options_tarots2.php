<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots2') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex2') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names2')!== false) ? get_option( 'tarokki_tarot_names2') : array() ;
			...
			update_option( 'tarokki_tarot_names2',$tarotsN2);
			update_option( 'tarokki_tarotsAll2',$tarotsAll);
			update_option( 'tarokki_EDD_products2',$restrict_post_id);
