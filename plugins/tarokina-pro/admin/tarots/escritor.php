...
// theme_options, complex, tarots/vista.php, tarot list, include_once
////////////////////////////////////////////////////////////////////////
...
if (get_option('_tkna_more_tarots')) {
    $Title_list = esc_html__('Tarots', 'tarokina-pro').'&nbsp;1-10';
}else{
    $Title_list = esc_html__('Tarot list', 'tarokina-pro');
}
...
update_option( 'tarokki_carpeta_tarots', $carpeta_tarots );
    ...
    Container::make( 'theme_options', 'tarots',  esc_html__('Tarots','tarokina-pro')  )
    ...
    Field::make( 'html', 'tarokki_cabecera_text_tarots' )
        ...
        </ul><div class=\"titleFormsBloq\"><div class=\"titleForms\">".$Title_list."</div><span class=\"dashicons dashicons-arrow-down-alt2\"></span></div>
        ')->set_classes( 'infoTarots' ),
    Field::make( 'complex', 'tarokki_tarot_complex', '' )
    ->set_collapsed( true )
    ->set_max('10')
    ...
    $FOOTER = "
    ,Field::make( 'html', 'tarokki_btn_delete_tarot' )->set_html( '<a href=\"edit.php?post_type=tarokkina_pro&tarots=0&del=1&page=crb_carbon_fields_container_tarots.php\" id=\"del_tarots\" class=\"button del_tarots\">".esc_html__('Delete tarot', 'tarokina-pro')."</a>')->set_classes( 'html_del_tarots' )
        ));
    ";
...
////////////////////////////////////////////////////////////////////////////////
    ...
    include_once TAROKINA_LIB_PATH . 'tarokina-pro/fields.php';
    ...
    $escribir = fopen(TAROKINA_ADMIN_PATH."tarots/vista.php", "w");
