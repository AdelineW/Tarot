<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots9') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex9') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names9')!== false) ? get_option( 'tarokki_tarot_names9') : array() ;
			...
			update_option( 'tarokki_tarot_names9',$tarotsN2);
			update_option( 'tarokki_tarotsAll9',$tarotsAll);
			update_option( 'tarokki_EDD_products9',$restrict_post_id);
