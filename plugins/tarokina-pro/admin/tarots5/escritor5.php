...
update_option( 'tarokki_carpeta_tarots', $carpeta_tarots );	
    ...
    Container::make( 'theme_options', 'tarots5', esc_html__('Tarots','tarokina-pro') )
    ...
    Field::make( 'html', 'tarokki_cabecera_text_tarots' )
        ...
        </ul><div class=\"titleFormsBloq\"><div class=\"titleForms\">'.esc_html__( 'Tarots','tarokina-pro' ).'&nbsp;41-50</div><span class=\"dashicons dashicons-arrow-down-alt2\"></span></div>
        ')->set_classes( 'infoTarots' ),
    Field::make( 'complex', 'tarokki_tarot_complex5', '' )
    ->set_collapsed( true )
    ->set_max('10')
...
////////////////////////////////////////////////////////////////////////////////
    ...
    $escribir = fopen(TAROKINA_ADMIN_PATH."tarots5/vista5.php", "w");
