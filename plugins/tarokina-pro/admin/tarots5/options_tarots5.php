<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots5') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex5') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names5')!== false) ? get_option( 'tarokki_tarot_names5') : array() ;
			...
			update_option( 'tarokki_tarot_names5',$tarotsN2);
			update_option( 'tarokki_tarotsAll5',$tarotsAll);
			update_option( 'tarokki_EDD_products5',$restrict_post_id);
