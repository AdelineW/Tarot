<?php
			...
			if ($pageId == 'tarokkina_pro_page_crb_carbon_fields_container_tarots6') {
				$tarots = carbon_get_theme_option('tarokki_tarot_complex6') ?? [];
			}else{
			...
			$guadandoNames = (get_option( 'tarokki_tarot_names6')!== false) ? get_option( 'tarokki_tarot_names6') : array() ;
			...
			update_option( 'tarokki_tarot_names6',$tarotsN2);
			update_option( 'tarokki_tarotsAll6',$tarotsAll);
			update_option( 'tarokki_EDD_products6',$restrict_post_id);
