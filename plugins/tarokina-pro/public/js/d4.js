...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  window.addEventListener("load", function() {
    ...
    let imgSpread = document.getElementById('imgSpread');
    ...
    let dataTarotext = document.getElementById('dev_info_tarot').getAttribute('data-tarotext');
    let dataTarotempty = document.getElementById('dev_info_tarot').getAttribute('data-tarotempty');
    let dataTarototal = document.getElementById('dev_info_tarot').getAttribute('data-tarototal');
    subTitle.innerHTML=`
    <div class="panelBloq">
      <div class="panelTotal">${dataTarototal}</div>
      <div class="panelText pa_${dataTarotext}">${dataTarotext}</div>
      <div class="panelEmpty pa_${dataTarotempty}">${dataTarotempty}</div>
    </div>
    `;
            ...
            function ClickCard(e){
              ...
              if (count == 1) {
                ...
                setTimeout(() => {
                  ...
                  imgSpread.style.display="none";  
                  let dataName = document.getElementById(img_ID).getAttribute('data-name');
                  let dataText = document.getElementById(img_ID).getAttribute('data-text');
                  let dataEmpty = document.getElementById(img_ID).getAttribute('data-empty');
                  let dataTotal = document.getElementById(img_ID).getAttribute('data-total');
                  spreadTitle.innerHTML=dataName;
                  subTitle.innerHTML=`
                  <div class="panelBloq">
                    <div class="panelTotal">${dataTotal}</div>
                    <div class="panelText pa_${dataText}">${dataText}</div>
                    <div class="panelEmpty pa_${dataEmpty}">${dataEmpty}</div>
                  </div>`;
              ...
              if (count <= numero_spread) {
                 ...
                 document.getElementById('TitleSelect2').innerHTML=ajax_tarot.refe[count];
                  ...
                  anime({
                    ...
                    delay: 600,
                    update: function() {
                       document.getElementById(backface_ID).classList.add("rotate");
              ...
              if (count == numero_spread -1) {
                ...
                document.getElementById('TitleSelect2').style.display='inline-block';
              }
